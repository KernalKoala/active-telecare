  ...
  return (
    <>
      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
        ...
        {/* Desktop Menu */}
        <ul className="hidden md:flex space-x-7 lg:space-x-10 font-bold uppercase h-full items-center font-inter">
          ...
          <li className="h-full flex items-center"><Link href="/catalogue" className={pathname === '/catalogue' ? 'text-[#3ebdad] border-b-4 border-[#3ebdad] h-full flex items-center' : 'text-gray-700 hover:text-[#3ebdad]'}>Catalogue</Link></li>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white/95 border-t">
          <ul className="flex flex-col font-inter">
            ...
            <li><Link href="/catalogue" onClick={() => setMobileMenuOpen(false)} className={`block px-4 py-3 ${pathname === '/catalogue' ? 'text-[#3ebdad] bg-gray-50' : 'text-gray-700'}`}>Catalogue</Link></li>
